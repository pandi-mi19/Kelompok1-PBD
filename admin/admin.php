	...
	?>
      ...
      <div class="jumbotron">
        ...
        <p>Halo <strong><?php echo $_SESSION['username']; ?></strong>, Anda login sebagai
			<strong>
			<?php
				if($_SESSION['jenisuser'] == "1" && $_SESSION['level'] == "10"){
					echo "Super Admin.<br>";
					echo "Anda dapat melakukan crud pada data user dan prodi...";
				} else if($_SESSION['jenisuser'] == "1" && $_SESSION['level']== "11") {
						echo "Admin.<br>";
						echo "Anda hanya dapat melakukan crud pada data mahasiswa...";
				}else{
					echo 'User-Client.';
				}
			?>
