...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Bulan Mei 2021 pada 11.55
...
(2, '19753053', 'Pingko Sony Pratama', 13),
(3, '19753046', 'Nur Ikhsan Fajri', 13),
(5, '19753048', 'Nurul Khusnia', 13),
(6, '19753059', 'Riski Safitri H', 13),
(7, '19753039', 'Muslim Maarif', 14);
...
(4, 'ikhsan', 'admin', '1', '11', 'T', 13),
(5, 'pingko', 'user', '0', '00', 'T', 13),
(6, 'Riski', 'user', '0', '00', 'T', 13),
(7, 'nurul', 'user', '0', '00', 'T', 13),
(8, 'muslim', 'user', '0', '00', 'T', 13);
...
--
ALTER TABLE `dt_prodi`
  MODIFY `idprodi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
